...
If all is well, at this point we should be able to open our page and see a triangle:

<img src="{{ site.url }}/assets/webgl-triangle-1.png" style="border:none; width: 100%;">
