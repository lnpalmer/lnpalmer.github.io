...
To get started, install [node](https://nodejs.org) on your machine and install the [socket.io] package:

    $ npm install socket.io

You'll also want to install the [express] for serving web pages:
